...
public class BestManhuasCrawler extends LastChapterCrawler {
    ...
    public BestManhuasCrawler(String lastChapter) {
        super(lastChapter);
    }
    ...
    public CrawledData.Chapter findNextChapter() {
        ...
        SiteCrawler siteCrawler = new BestManhuasCrawler(nextChapterUrl);
    ...
    public CrawledData.Chapter findLastChapter() {
        ...
        LOGGER.info("BestManhuasId " + mangaId);

        String phpMangaList = "https://bestmanhuas.com/wp-admin/admin-ajax.php";
        Document doc3;
        try {
            LOGGER.info("Crawling bestmnahuasite: " + phpMangaList);
    ...
    public static void main(String[] args) {
        ...
        BestManhuasCrawler s = new BestManhuasCrawler(mangaUrl);
        s.findLastChapter();
    }

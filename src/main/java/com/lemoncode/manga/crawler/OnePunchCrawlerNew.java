...
public class OnePunchCrawlerNew extends LastChapterCrawler {
    ...
    public OnePunchCrawlerNew(String lastChapter) {
        super(lastChapter);
    }
    ...
    public CrawledData.Chapter findNextChapter() {
        ...
        SiteCrawler siteCrawler = new OnePunchCrawlerNew(nextChapterUrl);
    ...
    public static void main(String[] args) {
        ...
        OnePunchCrawlerNew s = new OnePunchCrawlerNew(mangaUrl);
        s.findLastChapter();
    }

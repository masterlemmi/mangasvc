...
public class MangahaCrawler extends LastChapterCrawler {

    private String chapterTitle;
    private String mainTitle;
    private String mainUrl;
    private String nextChapterUrl;
    private final static String BASE_SITE = "https://" + MangaSite.MANGAHA.getUrl()[0];

    public MangahaCrawler(String lastChapter) {
        super(lastChapter);
    }
    ...
    public CrawledData.Chapter findNextChapter() {
        ...
        SiteCrawler siteCrawler = new MangahaCrawler(nextChapterUrl);
    ...
    public static void main(String[] args) {
        ...
        MangahaCrawler s = new MangahaCrawler(mangaUrl);
        s.findLastChapter();
    }
    ...
    private void scanBreadCrumb() {
        ...
        this.mainUrl = BASE_SITE + main.attr("href");
